...
class Quart(Scaffold):
    ...
    def register_blueprint(
        ...
        **options: Any,
        ...
        This results in the blueprint's router, error handlers
        etc... being added to the app.

        Arguments:
            blueprint: The blueprint to register.
            url_prefix: Optional prefix to apply to all paths.
            url_defaults: Blueprint router will use these default values for view arguments.
            subdomain: Blueprint router will match on this subdomain.
        """
        ...
        *,
        ...
        Arguments:
            ...
            provide_automatic_options: Optionally False to prevent
                OPTION handling.
            methods: List of HTTP verbs the function router.
