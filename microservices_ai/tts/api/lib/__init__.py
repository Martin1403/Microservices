...
import onnxruntime
import phonemes2ids
from tts.api.lib.glow_tts import GlowTextToSpeech

from tts.api.lib.audio import AudioSettings
from tts.api.lib.constants import (
    InferenceBackend,
    TextToSpeechModel,
...
def load_vocoder_model(
    ...
    if model_type == VocoderType.GRIFFIN_LIM:
        from tts.api.lib.griffin_lim import GriffinLimVocoder

        return GriffinLimVocoder(config)

    if model_type == VocoderType.HIFI_GAN:
        from tts.api.lib.hifi_gan import HiFiGanVocoder
